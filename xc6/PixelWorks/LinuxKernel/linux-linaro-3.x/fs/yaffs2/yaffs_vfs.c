						     ...
						     void *data, int silent)
{
	...
	if (!sb->s_dev)
		printk(KERN_DEBUG "yaffs: sb->s_dev is NULL\n");
	else if (!yaffs_devname(sb, devname_buf))
		printk(KERN_DEBUG "yaffs: devname is NULL\n");
	else
		printk(KERN_DEBUG "yaffs: dev is %d name is \"%s\" %s\n",
		       sb->s_dev,
	...
	printk(KERN_DEBUG "yaffs: passed flags \"%s\"\n", data_str);
