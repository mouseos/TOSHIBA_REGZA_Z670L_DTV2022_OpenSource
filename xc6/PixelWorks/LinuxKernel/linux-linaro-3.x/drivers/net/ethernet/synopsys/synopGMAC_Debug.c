...
#include "../../../../include/uapi/linux/mii.h"
...
{
  { MII_BMCR,       "Phy Control Reg" },
  { MII_BMSR,       "Phy Status  Reg" },
  { MII_PHYSID1,    "Phy Id (02)    " },
  { MII_PHYSID2,    "Phy Id (03)    " },
  { MII_ADVERTISE,  "Auto-nego   Adv" },
  { MII_LPA,        "Auto-nego   Lpa" },
  { MII_EXPANSION,  "Auto-nego   Exp" },
  { 0x0007,         "Auto-nego    Np" },
  { MII_CTRL1000,   "1000 Ctl    Reg" },
  { MII_STAT1000,   "1000 Sts    Reg" },
  { MII_MMD_CTRL,   "address	 Reg" },
  { MII_MMD_DATA,   "data		 Reg" },
  { MII_ESTATUS,    "Ext status  Reg" },
  { 0x0010,         "PHY  Ctl    Reg" },
  { 0x0011,         "PHY  Sts    Reg" },
  { MII_DCOUNTER,   "PHY  LinkMD Reg" },
  { MII_FCSCOUNTER, "False Carrier Cnt" },
  { MII_NWAYTEST,   "N-Way autoneg test" },
  { MII_RERRCOUNTER,"Recv Err Reg"  },
  { MII_SREVISION,  "Silicon Rev Reg" },
  { MII_RESV1,      "Reserved" },
  { MII_LBRERROR,   "Lpback error" },
  { MII_PHYADDR,    "Phy Addr Reg" },
  { MII_RESV2,      "Reserved" },
  { MII_TPISTATUS,  "TPI status for 10mbps" },
  { MII_NCONFIG,    "NetIF Confi" },  	
  { 0, 0 }
};
...
static char usage[] =
    ...
    "\n"
    "  Commands:\n"
    "    dump          <unit>  - dump registers,     unit ::= {mac|dma|mii|mmc}\n"
    "    read	       <unit> <reg>		     unit ::= {mac|dma|mii}"
    "    write/set/clr <unit> <reg> <value>\n"
    "                 - write/set/clr bits\n"
...
static int read(char *ifname, int argc, char *argv[])
{
  ...
  ifr.ifr_data = (void *) &data;
   ...
   if((data.unit == 0) && ((data.addr > 0x000002FC) || ((data.addr & 0x00000003) != 0)))
	return 1;
   if((data.unit == 1) && ((data.addr > 0x00000054) || ((data.addr & 0x00000003) != 0)))
	return 1;
