...
void rc_keydown2(struct rc_dev *dev, int scancode, u32 keycode, u8 toggle)
{
	unsigned long flags;
...
EXPORT_SYMBOL_GPL(rc_keydown_notimeout2);
...
int rc_core_debug = 6;    /* ir_debug level (0,1,2) */
