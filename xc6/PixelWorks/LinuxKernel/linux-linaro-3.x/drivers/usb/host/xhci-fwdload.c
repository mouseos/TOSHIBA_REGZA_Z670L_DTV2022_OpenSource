...
#define XHCI_FWFILENAME_720201_202ES20  "renesas/K2006040.mem"

static char fwfilename[32];
module_param_string(fwfilename, fwfilename, sizeof(fwfilename), 0);
MODULE_PARM_DESC(fwfilename, "firmware file name. Allows overriding the "
...
//        xhci->firmware_pointer = NULL;
        ...
        if (fwfilename[0]) {
            firmwarename = fwfilename;
        } else if((pDev->vendor == XHCI_VENDOR_ID_720201)&&(pDev->device == XHCI_DEVICE_ID_720201)&&(pDev->revision == XHCI_DEVICE_REV_ES12)) {
