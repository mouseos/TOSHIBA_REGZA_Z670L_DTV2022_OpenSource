...
#ifdef CONFIG_USB_XHCI_RENESAS_FWDOWNLOAD
...
#ifdef CONFIG_PLAT_XCODE64xx
	val_lo = xcode_xhci_readl(ptr);
	val_hi = xcode_xhci_readl(ptr + 1);
#else
	val_lo = readl(ptr);
	val_hi = readl(ptr + 1);
#endif
...
#ifdef CONFIG_PLAT_XCODE64xx
	xcode_xhci_writel(val_lo, ptr);
	xcode_xhci_writel(val_hi, ptr + 1);
#else
	writel(val_lo, ptr);
	writel(val_hi, ptr + 1);
#endif
