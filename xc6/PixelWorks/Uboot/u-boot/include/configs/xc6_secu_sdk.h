 ...
 */
/* Quiet Console, configures to disable console Tx/Rx func */
//#define CONFIG_CON_NO_TX	1
#define CONFIG_CON_NO_RX	1
...
//#define CONFIG_SCSA
#ifdef CONFIG_SCSA
#define CONFIG_CERT_OFFSET	(0x1A0000)
#define CONFIG_CERT_LENGTH	(64 * 1024)
#define CONFIG_SCSA_KEY_CNT	22
#define CONFIG_KEY_LENGTH	(CONFIG_SCSA_KEY_CNT * (128 >> 3))
#define CONFIG_KEY_OFFSET	(0x1B0000)
#define CONFIG_SCSA_KEY_BASE 6
#define CONFIG_SCSA_KEY_SRC	84
#define CONFIG_OTP_KEYLOAD	1
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"sata_clktype=1\0" \
	"sata_ssmode=1\0" \
	"set_bootargs=setenv bootargs ethaddr=$ethaddr eth1addr=$eth1addr sata_clkfreq=$sata_clkfreq sata_clktype=$sata_clktype root=/dev/sda2 rootwait\0" \
