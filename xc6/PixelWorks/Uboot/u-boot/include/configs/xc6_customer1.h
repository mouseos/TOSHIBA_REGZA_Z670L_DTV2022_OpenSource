...
#define CONFIG_SH_MODIFY    // source code modified by customer
...
#define CONFIG_SYS_I2C_BUS		1
#define CONFIG_CMD_EEPROM
#define CONFIG_SYS_I2C_EEPROM_ADDR 0x50
#define CONFIG_SYS_I2C_EEPROM_ADDR_LEN 2
#ifdef CONFIG_CMD_EEPROM
#define CONFIG_VERINFO_IN_EEPROM
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"sata_clktype=1\0" \
	"sata_ssmode=1\0" \
	"set_bootargs=setenv bootargs ethaddr=$ethaddr root=/dev/ram0 initrd=$initrd_addr,$initrd_size init=linuxrc\0" \
	"loadaddr=0x10000000\0" \
	"verifyaddr=0x20000000\0" \
	"flash_boot_ofs=0x10000\0" \
	"flash_boot_sz=0x90000\0" \
	...
	"bootemmc=mmc dev 0; mmcboot 10000000 0; mmcbootnw e0000000 0; run set_bootargs; bootm 10000000\0"\
	"ethaddr=00:88:23:84:17:41\0" \
	"netmask=255.255.0.0\0"\
	"watchdog=off\0" \
	"memtest=dcache off; mtest; dcache on\0" \
	"memsize=0x40000000\0" \
	"bootdevice=0\0" \
	""
#endif
...
#define CONFIG_XCODE6_BOARDID	(0x1100)
