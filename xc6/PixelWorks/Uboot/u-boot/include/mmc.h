...
#define TIMEOUT			-19 /* operation timeout */
#define INVAL_PARAM     -20 /* invalid parameters */
...
#define BOOT_PART_MASK		(0x7 << 3)
#define PART_ACCESS_MASK	(0x7)
#define PARTCONF_MASK		(BOOT_PART_MASK | PART_ACCESS_MASK)
