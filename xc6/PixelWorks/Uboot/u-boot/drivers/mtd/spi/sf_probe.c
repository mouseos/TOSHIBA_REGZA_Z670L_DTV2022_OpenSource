...
static const struct spi_flash_params spi_flash_params_table[] = {
	...
	{"MX25L1633E",	   0xc22415, 0x0,	64 * 1024,    32,	             0},
	{"MX25L1636E",	   0xc22515, 0x0,	64 * 1024,    32,	       SECT_4K},
	...
	{"MX25L6455E",	   0xc22617, 0x0,	64 * 1024,   128,	             0},
	...
	{"S25FL512S_64K",  0x010220, 0x4d03,    64 * 1024,  1024,	         0},
	{"S25FL116K",	   0x014015, 0x0,    64 * 1024,  32,	       SECT_4K},
	{"S25FL132K",	   0x014016, 0x0,    64 * 1024,  64,	       SECT_4K},
	{"S25FL164K",	   0x014017, 0x0,    64 * 1024,  128,	       SECT_4K},
#endif
	...
	{"M25PE80",	   0x208014, 0x0,       64 * 1024,    16,	             0},
	{"M25PE16",	   0x208015, 0x0,       64 * 1024,    32,	       SECT_4K},
	{"M25PX80",	   0x207114, 0x0,       64 * 1024,    16,	       SECT_4K},
	{"M25PX16",	   0x207115, 0x0,       64 * 1024,    32,	       SECT_4K},
	{"M25PX32",	   0x207115, 0x0,       64 * 1024,    64,	       SECT_4K},
	...
	{"W25Q16BV",   0xef4015, 0x0,	64 * 1024,    32,	      SECT_4K},
	...
	{"W25Q16JVD",  0xef7015, 0x0,	64 * 1024,    32,	      SECT_4K},
#endif
	/*
	 * Note:
		...
		unsigned int max_hz, unsigned int spi_mode)
{
	...
	if (!flash){
        printf("Warning do not find the valid spi flash!\n");
		goto err_read_id;
    }
#ifdef CONFIG_OF_CONTROL
	...
	print_size(flash->erase_size, ", sector size ");
