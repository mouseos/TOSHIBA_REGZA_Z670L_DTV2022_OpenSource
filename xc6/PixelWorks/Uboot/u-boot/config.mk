...
XCFLAGS= -DHGVER=$(shell $(TOPDIR)/tools/get_hg_version.sh)

OBJCFLAGS += --gap-fill=0xff

gccincdir := $(shell $(CC) -print-file-name=include)

CPPFLAGS := $(DBGFLAGS) $(OPTFLAGS) $(RELFLAGS) $(XCFLAGS)		\
	-D__KERNEL__
...
ifneq ($(CONFIG_XCODE),)
CPPFLAGS += -DCONFIG_XCODE -DCONFIG_SYS_JUMP_BASE=$(CONFIG_SYS_JUMP_BASE) -DCONFIG_SYS_SDRAM_BASE=$(CONFIG_SYS_SDRAM_BASE) -fpic -fPIC #-mno-unaligned-access 
endif
